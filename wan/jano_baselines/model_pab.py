...
from .pab_manager import get_pab_manager
...
class WanSelfAttention(nn.Module):
    ...
    def forward(self, x, seq_lens, grid_sizes, freqs):
        ...
        # x = sageattn(
        #         q=rope_apply(q, grid_sizes, freqs).transpose(1, 2).to(torch.bfloat16),  
        #         k=rope_apply(k, grid_sizes, freqs).transpose(1, 2).to(torch.bfloat16), 
        #         v=v.transpose(1, 2), 
        #         tensor_layout="HND", 
        #         is_causal=False)
...
class WanT2VCrossAttention(WanSelfAttention):
    ...
    def forward(self, x, context, context_lens):
        ...
        # x=sageattn(q,k,v,k_lens=context_lens,tensor_layout="HND", 
        #         is_causal=False)
    ...
    def __init__(self,
        ...
        self.blocks = nn.ModuleList([
            WanAttentionBlock(cross_attn_type, dim, ffn_dim, num_heads,
                              window_size, qk_norm, cross_attn_norm, eps, id)
