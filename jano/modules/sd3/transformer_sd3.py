...
from .attention_processor import JointAttnProcessor2_0, JointAttnProcessor_jano

from jano.stuff import get_masked_timer, get_timestep
from jano.mask_manager.sd3_mask_manager import get_mask_manager
...
class SD3Transformer2DModel(
    ...
    def forward(
        ...
        # print(f"1:{hidden_states.shape=}", flush=True)
        ...
        # print(f"2:{hidden_states.shape=}", flush=True)
        ...
        with get_masked_timer("DiT"):
            ...
            # print(f"{get_timestep()} | {hidden_states.shape=}", flush=True)
        ...
        if mask_manager is not None:
            print(f"{get_timestep()} | output: {hidden_states.shape=}", flush=True)
            hidden_states = mask_manager.process_masked_sequence(hidden_states, "output", layer_idx=-1)
