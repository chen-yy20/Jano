...
from .stuff import transformer_to_std_shape, pack_latents

from jano.stuff import update_timestep, get_timestep
from jano.dynamic_analyzer import DynamicAnalyzer
from jano.mask_manager.sd3_mask_manager import init_mask_manager
...
class StableDiffusion3Pipeline(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin, SD3IPAdapterMixin):
    ...
    def __call__(
        ...
        if GlobalEnv.get_envs("enable_stdit"):
            ...
            analyzer.step(latent=transformer_to_std_shape(latents))
