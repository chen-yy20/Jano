...
def _parse_args():
    ...
    type=int,
    default=None,
    help="(Optional) Sample index for VBench naming, e.g., 0, 1, 2."
    )
    ...
    type=str,
    default="./",
    help="The directory to save generated files. Default: ./")

    args = parser.parse_args()
    args.prompt = PROMPT
    args.ckpt_dir = MODEL_PATH
    GlobalEnv.set_envs("enable_pab", ENABLE_PAB)
    GlobalEnv.set_envs("self_range", SELF_RANGE)
    GlobalEnv.set_envs("cross_range", CROSS_RANGE)
